...
class PlayerStats(Base):
    ...
    pass_success_rate_percent = Column(Float)
    extra_shots_percent = Column(Float)
    first_time_shots_percent = Column(Float)
    shots_on_target_percent = Column(Float)
    assists_90 = Column(Float)
    goals_90 = Column(Float)